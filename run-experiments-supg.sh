...
robot_list=(gecko7 spider9 babyA snake5 gecko12 spider13 babyB snake7 gecko17 spider17 babyC snake9)
#robot_list=(gecko7 spider9 babyA snake5)
#robot_list=(gecko12 spider13 babyB snake7)
#robot_list=(gecko17 spider17 babyC snake9)
light_orientation_list=(CENTER LEFT RIGHT MORELEFT MORERIGHT)
...
#            robot_23 robot_24 robot_25 robot_26 robot_27 robot_28 robot_29 \
#            robot_30 robot_31 robot_32 robot_33 robot_34 robot_35 robot_36 \
#            robot_37 robot_38 robot_39 robot_40)
...
function main() {
    ...
    for light_orientation_i in ${!light_orientation_list[*]}
    do
    local light_orientation=${light_orientation_list[$light_orientation_i]}
        for index in ${!robot_list[*]}
        do
            for (( i = 1; i <= ${no_experiments}; ++ i ))
            do
                local log_dir="results/${robot_list[$index]}/${light_orientation}/${i}"
